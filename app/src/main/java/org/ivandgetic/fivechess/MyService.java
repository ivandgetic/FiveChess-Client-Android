                                        ...
                                        public void run() {
                                            ...
                                            if (separate[0].equals("operate")) {
                                                ...
                                                if (separate[1].equals("invitefrom")) {
                                                    ...
                                                    new AlertDialog.Builder(MyActivity.getMyActivity()).setTitle("Invite from: " + separate[2]).setPositiveButton(getString(R.string.button_agree), new DialogInterface.OnClickListener() {
                                                        @Override
                                            ...
                                            if (separate[0].equals("play")) {
                                                if (separate[1].equals("place")) {
                                                    ...
                                                    GameView.getGameView().invalidate();
                                                    GameView.check();
                                                }
